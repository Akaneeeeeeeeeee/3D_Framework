...
void Hole1Scene::Init()
{
	...
	ground->SetImage("assets/texture/Hole1.png");	// 地形を設定
...
// スコアを取得
int Hole1Scene::GetScore(void) 
{
	// 現在打数から標準打数を引いた値を返す
	return (m_StrokeCount - m_Par);
}

int Hole1Scene::GetTargetScore(void)
{
	return m_Par;
}
