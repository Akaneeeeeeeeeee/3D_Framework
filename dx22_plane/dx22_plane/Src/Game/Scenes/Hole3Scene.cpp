...
void Hole3Scene::Init()
{
	...
	ground->SetImage("assets/texture/Hole3Image.jpeg");	// 地形を設定
...
// スコアを取得
int Hole3Scene::GetScore(void)
{
	// 現在打数から標準打数を引いた値を返す
	return (m_StrokeCount - m_Par);
}

int Hole3Scene::GetTargetScore(void)
{
	return m_Par;
}
